...
class Footer extends React.Component {
    ...
    render() {
        return <div>
            <footer className={`bg-${this.props.themeMode.background} text-${this.props.themeMode.color}`}>
                <div className="container py-5">
                    <div className="row py-3">

                        <div className="col-lg-2 col-md-6 mb-4 mb-lg-0 footer-text-color">
                            <h6 className="text-uppercase font-weight-bold mb-4 footer-text-color">About</h6>
